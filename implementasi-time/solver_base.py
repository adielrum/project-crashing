...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--activity-data",
        default="../data/activity_data.json",
        help="Path to activity_data JSON",
    )
    parser.add_argument(
        "--resource-capacity",
        default="../data/resource_capacity.json",
        help="Path to resource_capacity JSON",
    )
    parser.add_argument(
        "--resource-requirements",
        default="../data/resource_requirements.json",
    ...
    parser.add_argument(
        "--output-json",
        default="./outputs/time-based/solution.json",
        help="Path to output solution JSON",
    )
    parser.add_argument(
        "--output-csv",
        default="./outputs/time-based/schedule.csv",
        help="Path to output schedule CSV",
    )
    parser.add_argument(
        "--output-gantt",
        default="./outputs/time-based/gantt_comparison.png",
        help="Path to output Gantt chart comparison plot (original vs crashed)",
    )
    parser.add_argument(
        "--output-resources",
        default="./outputs/time-based/resource_usage.png",
