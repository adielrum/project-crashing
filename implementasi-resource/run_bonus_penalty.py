...
def run_bonus_penalty():
    ...
    if solution is not None:
        ...
        out_json = os.path.join(base_dir, "../outputs/resource-based/cobb_bonus_penalty.json")
        out_gantt = os.path.join(base_dir, "../outputs/resource-based/cobb_bonus_penalty_gantt.png")
        out_html = os.path.join(base_dir, "../outputs/resource-based/cobb_bonus_penalty_gantt.html")
