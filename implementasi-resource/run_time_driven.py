...
def run_time_driven():
    ...
    if solution is not None:
        ...
        out_json = os.path.join(base_dir, "../outputs/resource-based/cobb_time_driven.json")
        out_gantt = os.path.join(base_dir, "../outputs/resource-based/cobb_time_driven_gantt.png")
        out_html = os.path.join(base_dir, "../outputs/resource-based/cobb_time_driven_gantt.html")
