...
def run_multiobjective():
    ...
    res_moo = solve(problem, pop_size=1200, tol=0.0005, seed=42, verbose=True)
    ...
    if res_moo is not None and res_moo.F is not None:
        ...
        out_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../outputs/resource-based")
