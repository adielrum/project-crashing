...
def solve_single(args):
    ...
    # Calculate penalty and bonus applied
...
if __name__ == "__main__":
    ...
    c_late_vals = np.linspace(0, 150, 100)
    c_early_vals = np.linspace(0, 200, 100)
    ...
    csv_path = os.path.join(out_dir, "grid_base_bonus_penalty_100x100.csv")
    ...
    axes[0].set_title('Optimal Makespan (Days)')
    ...
    plt.tight_layout()
    plot_path = os.path.join(out_dir, "grid_base_bonus_penalty_heatmap.png")
